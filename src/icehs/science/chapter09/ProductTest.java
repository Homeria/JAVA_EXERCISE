...
public class ProductTest {
	...
	public static void main(String[] args) {
		...
		Television tv1 = new Television("시네마TV", 3500000, 10, "화면 크기 151cm");
		...
		System.out.println(p1.getName() + " 판매가 : " + p1.calculateDiscountPrice() + "원");
		System.out.println(tv1.getName() + " 판매가  : " + tv1.calculateDiscountPrice() + "원");
	}
